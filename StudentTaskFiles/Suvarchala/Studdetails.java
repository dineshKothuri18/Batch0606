public class Studdetails {
    public static void main(String[] args) {
        ...
        System.out.printf("%-10s %-10s %-5s %-5s %-5s %-5s %-5s %-5s %-5s %-5s %-5s %5s %-15s%n", "Name", "Roll No", "Batch", "Java", "HTML", "SQL", "JS", "sum", "Avg", "Min", "Max", "Percent","pass/fail");
            for(int i=0;i<stname.length;i++) {
                ...
                if(java_marks[i]>=35 && html_marks[i]>=35 && sql_marks[i]>=35 && javascript_marks[i]>=35) {
                    ...
                    System.out.printf("%-10s %-10s %-5s %-5s %-5s %-5s %-5s %-5s %-5s %-5s %-5s %-5s     %-15s%n", stname[i], rollnumbers[i], batchname[i], java_marks[i], html_marks[i], sql_marks[i], javascript_marks[i], sumofmarkse, averageofmarkse, mini, maxi, percent,"pass");
                }
                else{
                    System.out.printf("%-10s %-10s %-5s %-5s %-5s %-5s %-5s %-5s %-5s %-5s %-5s %-5s     %-15s%n", stname[i], rollnumbers[i], batchname[i], java_marks[i], html_marks[i], sql_marks[i], javascript_marks[i], sumofmarkse, averageofmarkse, mini, maxi, percent,"fail");
                }
            }
