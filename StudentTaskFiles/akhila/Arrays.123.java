public class Arrays{
    public static void main(String[] args){
        ...
        int[] subjectJavaMarks = {75,85,95,56,59,65,74,60,68,58,89,87,70,71,80,69,63,66,99};
        ...
        for(int i=0; i<stuNames.length; i++){
            if(subjectJavaMarks[i]>=50 && subjectHTMLMarks[i]>=50 && subjectJSMarks[i]>=50 && subjectSQLMarks[i]>=50){
                ...
                System.out.println("Java Marks :" + subjectJavaMarks[i]);
                System.out.println("HTML Marks :" + subjectHTMLMarks[i]);
                System.out.println("SQL Marks :" + subjectSQLMarks[i]);
                System.out.println("JS Marks :" + subjectJSMarks[i]);
    ...
    int min1 = subjectJSMarks[0];
             ...
             System.out.println("Highest Marks in JS : " + max1);
    System.out.println("Least Marks in JS : " + min1);
    int min2 = subjectHTMLMarks[0];
             ...
             System.out.println("Highest Marks in HTML : " + max2);
    System.out.println("Least Marks in HTML : " + min2);
      int min3 = subjectSQLMarks[0];
             ...
             System.out.println("Highest Marks in SQL : " + max);
    System.out.println("Least Marks in SQL : " + min);
