...
public class Foodtask {
  public static void main(String[] args) {
    ...
    while (!end) {
      System.out.println("***** kadupu ninda thini vellu ra ayaa*****");
      System.out.println("yem kavalo chepandi boss.....!?");

      System.out.println("1. Hyderabadi Chicken Biryani = 250");
      System.out.println("2. Hyderabadi Mutton Biryani = 350");
      System.out.println("3. Fish Biryani = 245");
      System.out.println("4. Veg Biryani = 150");
      ...
      switch (ch) {
       case 1:
        ...
        System.out.println("Total: " + total + "/-");
          break;
        case 11:
       System.out.println("peru petandi");
       name = sc.next();
       System.out.println("number petandi");
       phone = sc.next();
       System.out.println("Address petandi chalu inka");
       address = sc.next();
  ...
  public static void generateBill(int total) {
    ...
    System.out.println("*******Vachinandhuku thanks bro!********");
  }
} 